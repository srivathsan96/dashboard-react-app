    ...
    <div className={classes.widget}>
      ...
      <div className={classes.bottom}>
        <div className={classes.left}>
          <span className={classes.title}>Artwork Approval Process</span>
        </div>
        <div className={classes.right}>
          <div className={classes.data}>
            ...
            <div className={classes.timeData}>
              <div className={classes.top}>
                <span className={classes.title}>On Time</span>
                <span className={classes.item}>
                  {widgetData.aapOnTimeCount}
                </span>
              </div>
              <div className={classes.bottom}>
                <span className={classes.title}>Delayed</span>
                <span className={classes.item}>
      ...
      <div className={classes.bottom}>
        <div className={classes.left}>
          <span className={classes.title}>Project Initiation Process</span>
        </div>
        <div className={classes.right}>
          <div className={classes.data}>
