...
const DrawerSection = (props) => {
    ...
    return (
        <div className={classes.drawerSection}>
            ...
            >
                <div>
                    {props.navbarTitle === 'All Projects' && <ProjectsDrawer project={project} />}
                    {props.navbarTitle === 'Dashboard' && <ComponentsDrawer product={product} />}
                    {props.navbarTitle === 'Start New Project' && <NewProjectDrawer projectTitle={projectTitle} initiatedBy={initiatedBy} initiatedDate={initiatedDate} />}
                </div>
            </Drawer>
        </div>
    );
